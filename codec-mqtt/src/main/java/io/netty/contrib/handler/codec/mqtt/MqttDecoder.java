...
import io.netty.contrib.handler.codec.mqtt.MqttProperties.IntegerProperty;
...
import static io.netty.contrib.handler.codec.mqtt.MqttCodecUtil.isValidMessageId;
import static io.netty.contrib.handler.codec.mqtt.MqttCodecUtil.isValidPublishTopicName;
import static io.netty.contrib.handler.codec.mqtt.MqttCodecUtil.resetUnusedFields;
import static io.netty.contrib.handler.codec.mqtt.MqttCodecUtil.validateFixedHeader;
import static io.netty.contrib.handler.codec.mqtt.MqttConstant.DEFAULT_MAX_BYTES_IN_MESSAGE;
import static io.netty.contrib.handler.codec.mqtt.MqttConstant.DEFAULT_MAX_CLIENT_ID_LENGTH;
import static io.netty.contrib.handler.codec.mqtt.MqttSubscriptionOption.RetainedHandlingPolicy;
